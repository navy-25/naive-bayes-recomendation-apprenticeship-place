...
<div class="container-fluid">
    <div class="panel panel-headline" style="margin-bottom:0px;background-color:#F5F5FA;box-shadow: 0 0px 0px rgba(0, 0, 0, 0.08)">
        ...
        <div class="panel-body" style="padding-bottom:0px">
            <form class="form-auth-small" method="POST" action="/home/kelola-tempat-pi/{{$lokasi->id}}/updatePTI"  enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <?php
                                ...
                                $Nilai_KJK = $lokasi->Nilai_KJK;
                                $Nilai_MJ = $lokasi->Nilai_MJ;
                                $Nilai_PCD = $lokasi->Nilai_PCD;
                                $Nilai_TA = $lokasi->Nilai_TA;
                                $Nilai_MP = $lokasi->Nilai_MP;
                                $Nilai_PBD = $lokasi->Nilai_PBD;
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select id="Nilai_KJK" name="Nilai_KJK"  class="form-control">
                                    <option value="{{$Nilai_KJK}}">{{$label_nilai[$index1]}}</option>
                                    @for ($i = 0; $i < $panjang; $i++)
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select id="Nilai_MJ" name="Nilai_MJ"  class="form-control">
                                    <option value="{{$Nilai_MJ}}">{{$label_nilai[$index2]}}</option>
                                    @for ($i = 0; $i < $panjang; $i++)
                                        <option value="{{$nilai[$i]}}">{{$label_nilai[$i]}}</option>
                                    @endfor
                                </select>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select id="Nilai_PCD" name="Nilai_PCD"  class="form-control">
                                    <option value="{{$Nilai_PCD}}">{{$label_nilai[$index3]}}</option>
                                    @for ($i = 0; $i < $panjang; $i++)
                                        <option value="{{$nilai[$i]}}">{{$label_nilai[$i]}}</option>
                                    @endfor
                                </select>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select id="Nilai_TA" name="Nilai_TA"  class="form-control">
                                    <option value="{{$Nilai_TA}}">{{$label_nilai[$index4]}}</option>
                                    @for ($i = 0; $i < $panjang; $i++)
                                        <option value="{{$nilai[$i]}}">{{$label_nilai[$i]}}</option>
                                    @endfor
                                </select>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select id="Nilai_MP" name="Nilai_MP"  class="form-control">
                                    <option value="{{$Nilai_MP}}">{{$label_nilai[$index5]}}</option>
                                    @for ($i = 0; $i < $panjang; $i++)
                                        <option value="{{$nilai[$i]}}">{{$label_nilai[$i]}}</option>
                                    @endfor
                                </select>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select id="Nilai_PBD" name="Nilai_PBD"  class="form-control">
                                    <option value="{{$Nilai_PBD}}">{{$label_nilai[$index6]}}</option>
                                    @for ($i = 0; $i < $panjang; $i++)
                                        <option value="{{$nilai[$i]}}">{{$label_nilai[$i]}}</option>
                                    @endfor
                                </select>
