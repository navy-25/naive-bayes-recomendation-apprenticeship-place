                ...
                <div class="col-md-12" style="padding-top:10px;padding-bottom:10px;border-radius: 15px 15px 15px 15px;margin-bottom:20px;background-color:white;box-shadow: 0 2px 5px rgba(0, 0, 0, 0.08)" >
                    ...
                    <form class="form-auth-small" method="POST" action="/home/rekomendasi/filter" enctype="multipart/form-data">
                        ...
                        <div class="button" style="margin-top:15px">
                            <button type="submit" style="border-radius:100px;width:150;background-color:#1ABB9C;color:white" class="btn"><i style="margin-right:10px" class="fa fa-retweet"></i> Cari</button>
                        </div>
                    </form>
                </div>
            </div>
...
<div class="container-fluid">
    ...
    <?php
        ...
        ?>
        <div class="panel-heading" style="padding-bottom:0px">
            <h3 class="panel-title" style="font-family:roboto;"><b><i style="margin-right:10px" class="lnr lnr-license"></i>Hasil Rekomendasi Tempat Magang</b> </h3>
        ...
        @for($i =0; $i < count($id_lokasi_hasil_prediksi)-1; $i++) 
            @foreach($tempat_magang as $x) 
                @if($id_lokasi_hasil_prediksi[$i] == $x->id AND $akurasi_hasil_prediksi[$i]>=0.5)
                    <?php
        ...
        <br><br>
        <div class="panel-heading" style="padding-bottom:0px">
            <h3 class="panel-title" style="font-family:roboto;"><b><i style="margin-right:10px" class="lnr lnr-bookmark"></i>Rekomendasi Lainya</b> </h3>
        ...
        @for($i =0; $i < count($id_lokasi_hasil_prediksi)-1; $i++) 
            @foreach($tempat_magang as $x) 
                @if($id_lokasi_hasil_prediksi[$i] == $x->id AND $akurasi_hasil_prediksi[$i]<=0.5)
                    <?php
                        $akurasi = number_format(($akurasi_hasil_prediksi[$i]*100)+20,2);
                        $pm = Auth::user()->peminatan;
                        $ps = Auth::user()->program_studi;
                    ?>
                    @if($x->id_program_studi == $pm AND $x->id_peminatan == $ps)
                                ...
                                <div class="row">
                                    <div class="col-md-12" style="padding-top:10px;padding-bottom:10px;border-radius: 15px 15px 15px 15px;background-color:white;box-shadow: 0 2px 5px rgba(0, 0, 0, 0.08)" >
                                        <div class="row">
                                            ...
                                            <div class="col-md-2">
                                                <div class="button" style="margin-top:15px">
                                                    <button type="submit" style="border-radius:100px;width:100%;background-color:#3498DB;color:white" class="btn">
                                                        <i style="margin-right:10px" class="fa fa-check-circle"></i> 
                                                        Pilih
                                                    </button>
                                                </div>
